...
/// <summary>
/// A generic class that manages a collection of objects of type T and allows iteration through them.
/// </summary>
...
public class Objs<T> : IEnumerable<T>
{
    ...
    /// <summary>
    /// Iterates through the collection and performs actions based on the type of objects.
    /// </summary>
    /// <param name="type">The type of action to perform (e.g., IInteractive, IBreakable, ICollectable).</param>
    public void IterateAction(Type type)
    {
